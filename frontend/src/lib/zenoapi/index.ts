...
export type { ProjectsDetails } from './models/ProjectsDetails';
...
export type { ReportsDetails } from './models/ReportsDetails';
export type { ReportsRequest } from './models/ReportsRequest';
