...
def is_project_public(project_uuid: str, request: Request):
...
def get_project_users(project_uuid: str, request: Request):
...
def get_project_orgs(project_uuid: str, request: Request):
...
def add_project_user(project_uuid: str, user: User, request: Request):
...
def add_project_org(project_uuid: str, organization: Organization, request: Request):
...
def update_project(project: Project, request: Request):
    ...
    Args:
        ...
        request (Request): http request to get user information from.
    """
    util.project_editor(project.uuid, request)
...
def update_project_user(project_uuid: str, user: User, request: Request):
...
def update_project_org(project_uuid: str, organization: Organization, request: Request):
...
def delete_project_user(project_uuid: str, user: User, request: Request):
...
def delete_project_org(project_uuid: str, organization: Organization, request: Request):
